...
parser = argparse.ArgumentParser(description='Converts SWIFT results into MATLAB table.')
...
scipy.io.savemat(filetag+".mat",{
    'ctable': np.array(SimResult.from_directory(filename).concentration_tsn),
